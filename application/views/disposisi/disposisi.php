<!-- Catatan
        - Modal untuk button disposisi (untuk disposisi pake static backdrop)
        - Modal untuk button lihat
        - Modal untuk button detail

        ---- Tambah TTD di dispo Karo (belum ada, masih bingo mo bking bagimana)
        ---- Total modal for dispo: 4 (Karo, KTU, Kabag, Jabfung)
        ---- Kalo mo pangge modal dispo yang laeng, ubah di bagian footer di function tabels->columnDefs->var btn, Ubah dpe data-bs-target
        sesuai dengan dpe id modal
 -->
...
<script>
    const myModalEl = document.getElementById('staticBackdropDispo')
    myModalEl.addEventListener('hide.bs.modal', event => {
        ...
        // $('#modal-body').find("input[type=text], textarea").val("").end();
    })
</script>